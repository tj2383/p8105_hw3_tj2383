...
![](p8105_hw3_tj2383_files/figure-markdown_github/unnamed-chunk-8-1.png) This plot is able to easily shows us which aisles the most number of orders are coming from. The largest peak is for fresh vegetables fresh fruits, so we know that the most orders come from this aisle.
