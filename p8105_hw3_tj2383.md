...
![](p8105_hw3_tj2383_files/figure-markdown_github/unnamed-chunk-3-1.png) This plot shows the number of locations in each state by year from 2002-2010. Due to the large number of states, this graph would not be an accurate way to figure out the number of locations in a particular state as it is difficult to discern the different lines.
...
![](p8105_hw3_tj2383_files/figure-markdown_github/unnamed-chunk-8-1.png) This plot is able to easily shows us which aisles the most number of orders are coming from. The largest peaks are for fresh vegetables and fresh fruits, so we know that the most orders come from these aisles.
...
![](p8105_hw3_tj2383_files/figure-markdown_github/unnamed-chunk-13-1.png)
...
![](p8105_hw3_tj2383_files/figure-markdown_github/unnamed-chunk-14-1.png)
