...
instacart_data %>% 
  ...
  labs(
    ...
    theme(legend.position = "bottom")
```
This plot is able to easily shows us which aisles the most number of orders are coming from. The largest peak is for fresh vegetables fresh fruits, so we know that the most orders come from this aisle.
